import pt, { isBefore, startOfHour, parseISO, format, subHours } from 'date-fns'
...
class AppointmentController {
  ...
  async delete(req, res) {
    ...
    if (isBefore(dateWithSub, new Date())) {
      return res.status(400).json({ error: 'You can only cancel appointment 2 hours in advance' })
    }
